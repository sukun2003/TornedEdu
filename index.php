...
<!-- Navigation Bar -->
	<header id="header">
		<nav>
			...
			<a class="get-started" href="index.php?logout='1'">
	...
	<footer>
		<div class="footer-container">
			<div class="left-col">
				...
				<p class="rights-text">Copyright © 2023 Sukun Garg All Rights Reserved.</p>
				<br><p><img src="images/icon/location.png"> 
				<p><img src="images/icon/phone.png"> +91-8085595932<br><img src="images/icon/mail.png">&nbsp; gargsukun@gmail.com</p>
			</div>
			<div class="right-col">
